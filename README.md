...
> Transform your job search from guesswork into intelligent decision-making with Google Gemini 2.0 AI

[![Chrome Web Store](https://img.shields.io/badge/Chrome%20Web%20Store-Available-brightgreen)](https://chrome.google.com/webstore)
[![Version](https://img.shields.io/badge/version-1.0.0-blue)](https://github.com/Sreenuraj/CoverMe-Support)
[![Privacy](https://img.shields.io/badge/privacy-local%20only-green)](https://sreenuraj.github.io/CoverMe-Support/privacy-policy.html)
...
| **💬 AI Chat** | [Watch Demo](https://github.com/Sreenuraj/CoverMe-Support/raw/main/demos/ai-chat-demo.mov) | Persistent career conversations |
| **⚡ Live Mode** | [Watch Demo](https://github.com/Sreenuraj/CoverMe-Support/raw/main/demos/live-mode-demo.mov) | Automatic job monitoring |
| **⚙️ Setup** | [Watch Demo](https://github.com/Sreenuraj/CoverMe-Support/raw/main/demos/options-setup-demo.mov) | Complete configuration walkthrough |
...
- **Multi-Tab Support**: Maintain state across job searches
- **Smart Recovery**: Automatic recovery from page refreshes
- **Background Processing**: Seamless user experience
...
### 2. **Setup (2 minutes)**
```
1. Get free Google Gemini API key (no credit card required)
   → Visit: https://ai.google.dev/
   → Create API key (250 requests/day free)
...
→ See color-coded compatibility in extension icon
→ Click for detailed breakdown

Deep Intelligence (2 minutes):
→ Click "Ask AI" for instant analysis
→ Use "Deep Research" for comprehensive guidance
→ Chat about specific job strategies

Profile Enhancement (ongoing):
→ Add discovered skills with + buttons
→ Let AI categorize skills automatically
...
- [Create an Issue](https://github.com/Sreenuraj/CoverMe-Support/issues/new)
...
- [Setup Video Guides](#-quick-demo-videos)
...
- **Build System**: Vite with Chrome Extension plugins
